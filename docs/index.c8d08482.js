 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U=[];var H;!function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"}(H||(H={}));const j={debug:H.DEBUG,verbose:H.VERBOSE,info:H.INFO,warn:H.WARN,error:H.ERROR,silent:H.SILENT},B=H.INFO,z={[H.DEBUG]:"log",[H.VERBOSE]:"log",[H.INFO]:"info",[H.WARN]:"warn",[H.ERROR]:"error"},$=(e,t,...n)=>{if(t<e.logLevel)return;const i=(new Date).toISOString(),s=z[t];if(!s)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[s](`[${i}]  ${e.name}:`,...n)};class V{constructor(e){this.name=e,this._logLevel=B,this._logHandler=$,this._userLogHandler=null,U.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in H))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?j[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,H.DEBUG,...e),this._logHandler(this,H.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,H.VERBOSE,...e),this._logHandler(this,H.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,H.INFO,...e),this._logHandler(this,H.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,H.WARN,...e),this._logHandler(this,H.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,H.ERROR,...e),this._logHandler(this,H.ERROR,...e)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class Y{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const G=new V("@firebase/app"),K={"@firebase/app":"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},Q=new Map,X=new Map;function J(e,t){try{e.container.addComponent(t)}catch(n){G.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Z(e){const t=e.name;if(X.has(t))return G.debug(`There were multiple attempts to register component ${t}.`),!1;X.set(t,e);for(const t of Q.values())J(t,e);return!0}function ee(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var de;de="",Z(new F("platform-logger",(e=>new Y(e)),"PRIVATE")),Z(new F("heartbeat",(e=>new le(e)),"PRIVATE")),ie("@firebase/app","0.7.19",de),ie("@firebase/app","0.7.19","esm2017"),ie("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
ie("firebase","9.6.9","app");var pe,_e,fe,ge=pe={};function me(){throw new Error("setTimeout has not been defined")}function ye(){throw new Error("clearTimeout has not been defined")}function ve(e){if(_e===setTimeout)return setTimeout(e,0);if((_e===me||!_e)&&setTimeout)return _e=setTimeout,setTimeout(e,0);try{return _e(e,0)}catch(t){try{return _e.call(null,e,0)}catch(t){return _e.call(this,e,0)}}}!function(){try{_e="function"==typeof setTimeout?setTimeout:me}catch(e){_e=me}try{fe="function"==typeof clearTimeout?clearTimeout:ye}catch(e){fe=ye}}();var Ce,we=[],be=!1,Te=-1;function Ee(){be&&Ce&&(be=!1,Ce.length?we=Ce.concat(we):Te=-1,we.length&&Ie())}function Ie(){if(!be){var e=ve(Ee);be=!0;for(var t=we.length;t;){for(Ce=we,we=[];++Te<t;)Ce&&Ce[Te].run();Te=-1,t=we.length}Ce=null,be=!1,function(e){if(fe===clearTimeout)return clearTimeout(e);if((fe===ye||!fe)&&clearTimeout)return fe=clearTimeout,clearTimeout(e);try{fe(e)}catch(t){try{return fe.call(null,e)}catch(t){return fe.call(this,e)}}}(e)}}function ke(e,t){this.fun=e,this.array=t}function Se(){}ge.nextTick=function(e){var t=new Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)t[n-1]=arguments[n];we.push(new ke(e,t)),1!==we.length||be||ve(Ie)},ke.prototype.run=function(){this.fun.apply(null,this.array)},ge.title="browser",ge.browser=!0,ge.env={},ge.argv=[],ge.version="",ge.versions={},ge.on=Se,ge.addListener=Se,ge.once=Se,ge.off=Se,ge.removeListener=Se,ge.removeAllListeners=Se,ge.emit=Se,ge.prependListener=Se,ge.prependOnceListener=Se,ge.listeners=function(e){return[]},ge.binding=function(e){throw new Error("process.binding is not supported")},ge.cwd=function(){return"/"},ge.chdir=function(e){throw new Error("process.chdir is not supported")},ge.umask=function(){return 0};
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht extends bt{constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}static getInstance(){return new Ht}getInitialEvent(e){return i("visible"===e,"Unknown event type: "+e),[this.visible_]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $t;class Vt extends zt{static get __EMPTY_NODE(){return $t}static set __EMPTY_NODE(e){$t=e}compare(e,t){return Ye(e.name,t.name)}isDefinedOn(e){throw s("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Bt.MIN}maxPost(){return new Bt("[MAX_NAME]",$t)}makePost(e,t){return i("string"==typeof e,"KeyIndex indexValue must always be a string."),new Bt(e,$t)}toString(){return".key"}}const Yt=new Vt;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function bn(e){return{type:"value",snapshotNode:e}}function Tn(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function En(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function In(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class kn{constructor(e){this.index_=e}updateChild(e,t,n,s,r,o){i(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(n.getChild(s))&&a.isEmpty()===n.isEmpty()?e:(null!=o&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(En(t,a)):i(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Tn(t,n)):o.trackChildChange(In(t,n,a))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(an,((e,i)=>{t.hasChild(e)||n.trackChildChange(En(e,i))})),t.isLeafNode()||t.forEachChild(an,((t,i)=>{if(e.hasChild(t)){const s=e.getImmediateChild(t);s.equals(i)||n.trackChildChange(In(t,i,s))}else n.trackChildChange(Tn(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?fn.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{Ln(i,new Et(t.toString()+"/"+e),n)}))}class Fn{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Je(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Wn,Un;function Hn(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Un=Wn||(Wn={}))[Un.OVERWRITE=0]="OVERWRITE",Un[Un.MERGE=1]="MERGE",Un[Un.ACK_USER_WRITE=2]="ACK_USER_WRITE",Un[Un.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class jn{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Wn.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(At(this.path)){if(null!=this.affectedTree.value)return i(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Et(e));return new jn(It(),t,this.revert)}}return i(kt(this.path)===e,"operationForChild called for unrelated child."),new jn(Nt(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,t){this.source=e,this.path=t,this.type=Wn.LISTEN_COMPLETE}operationForChild(e){return At(this.path)?new Bn(this.source,It()):new Bn(this.source,Nt(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Wn.OVERWRITE}operationForChild(e){return At(this.path)?new zn(this.source,It(),this.snap.getImmediateChild(e)):new zn(this.source,Nt(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Wn.MERGE}operationForChild(e){if(At(this.path)){const t=this.children.subtree(new Et(e));return t.isEmpty()?null:t.value?new zn(this.source,It(),t.value):new $n(this.source,It(),t)}return i(kt(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new $n(this.source,Nt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),a.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);r.forEach((s=>{s.respondsTo(n.type)&&t.push(s.createEvent(i,e.query_))}))}))}function Kn(e,t){return{eventCache:e,serverCache:t}}function Qn(e,t,n,i){return Kn(new Vn(t,n,i),e.serverCache)}function Xn(e,t,n,i){return Kn(e.eventCache,new Vn(t,n,i))}function Jn(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Zn(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ei;class ti{constructor(e,t=(()=>(ei||(ei=new Qt(Ge)),ei))()){this.value=e,this.children=t}static fromObject(e){let t=new ti(null);return Je(e,((e,n)=>{t=t.set(new Et(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:It(),value:this.value};if(At(e))return null;{const n=kt(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(Nt(e),t);if(null!=s){return{path:Dt(new Et(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(At(e))return this;{const t=kt(e),n=this.children.get(t);return null!==n?n.subtree(Nt(e)):new ti(null)}}set(e,t){if(At(e))return new ti(t,this.children);{const n=kt(e),i=(this.children.get(n)||new ti(null)).set(Nt(e),t),s=this.children.insert(n,i);return new ti(this.value,s)}}remove(e){if(At(e))return this.children.isEmpty()?new ti(null):new ti(null,this.children);{const t=kt(e),n=this.children.get(t);if(n){const i=n.remove(Nt(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new ti(null):new ti(this.value,s)}return this}}get(e){if(At(e))return this.value;{const t=kt(e),n=this.children.get(t);return n?n.get(Nt(e)):null}}setTree(e,t){if(At(e))return t;{const n=kt(e),i=(this.children.get(n)||new ti(null)).setTree(Nt(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new ti(this.value,s)}}fold(e){return this.fold_(It(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(Dt(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,It(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(At(e))return null;{const i=kt(e),s=this.children.get(i);return s?s.findOnPath_(Nt(e),Dt(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,It(),t)}foreachOnPath_(e,t,n){if(At(e))return this;{this.value&&n(t,this.value);const i=kt(e),s=this.children.get(i);return s?s.foreachOnPath_(Nt(e),Dt(t,i),n):new ti(null)}}foreach(e){this.foreach_(It(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(Dt(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Pi{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Vn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ei(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Zn(this.viewCache_),s=Ti(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xi(e,t,n,r,o){const a=new Si;let l,h;if(n.type===Wn.OVERWRITE){const s=n;s.source.fromUser?l=Ai(e,t,s.path,s.snap,r,o,a):(i(s.source.fromServer,"Unknown source."),h=s.source.tagged||t.serverCache.isFiltered()&&!At(s.path),l=Di(e,t,s.path,s.snap,r,o,h,a))}else if(n.type===Wn.MERGE){const s=n;s.source.fromUser?l=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=Dt(n,i);Mi(t,kt(h))&&(a=Ai(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=Dt(n,i);Mi(t,kt(h))||(a=Ai(e,a,h,l,s,r,o))})),a}(e,t,s.path,s.children,r,o,a):(i(s.source.fromServer,"Unknown source."),h=s.source.tagged||t.serverCache.isFiltered(),l=Li(e,t,s.path,s.children,r,o,h,a))}else if(n.type===Wn.ACK_USER_WRITE){const s=n;l=s.revert?function(e,t,n,s,r,o){let a;if(null!=bi(s,n))return t;{const l=new Pi(s,t,r),h=t.eventCache.getNode();let c;if(At(n)||".priority"===kt(n)){let n;if(t.serverCache.isFullyInitialized())n=vi(s,Zn(t));else{const e=t.serverCache.getNode();i(e instanceof fn,"serverChildren would be complete if leaf node"),n=Ci(s,e)}c=e.filter.updateFullNode(h,n,o)}else{const i=kt(n);let r=Ei(s,i,t.serverCache);null==r&&t.serverCache.isCompleteForChild(i)&&(r=h.getImmediateChild(i)),c=null!=r?e.filter.updateChild(h,i,r,Nt(n),l,o):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(h,i,fn.EMPTY_NODE,Nt(n),l,o):h,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=vi(s,Zn(t)),a.isLeafNode()&&(c=e.filter.updateFullNode(c,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=bi(s,It()),Qn(t,c,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return c}function cs(e,t,n){const i=e.pendingWriteTree_,s=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Xi(n,Mt(e,t));if(i)return i}));return yi(i,t,s,n,!0)}function us(e,t){return ds(t,e.syncPointTree_,null,pi(e.pendingWriteTree_,It()))}function ds(e,t,n,i){if(At(e.path))return ps(e,t,n,i);{const s=t.get(It());null==n&&null!=s&&(n=Xi(s,It()));let r=[];const o=kt(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=Ii(i,o);r=r.concat(ds(a,l,e,t))}return s&&(r=r.concat(Vi(s,e,i,n))),r}}function ps(e,t,n,i){const s=t.get(It());null==n&&null!=s&&(n=Xi(s,It()));let r=[];return t.children.inorderTraversal(((t,s)=>{const o=n?n.getImmediateChild(t):null,a=Ii(i,t),l=e.operationForChild(t);l&&(r=r.concat(ps(l,s,o,a)))})),s&&(r=r.concat(Vi(s,e,i,n))),r}function _s(e,t){const n=t.query,i=fs(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||fn.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=ms(e,n);if(i){const n=ys(i),s=n.path,r=n.queryId,o=Mt(s,t);return vs(e,s,new Bn(Hn(r),o))}return[]}(e,n._path,i):function(e,t){return us(e,new Bn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return ls(e,n,null,i)}}}}function fs(e,t){const n=gs(t);return e.queryToTagMap.get(n)}function gs(e){return e._path.toString()+"$"+e._queryIdentifier}function ms(e,t){return e.tagToQueryMap.get(t)}function ys(e){const t=e.indexOf("$");return i(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Et(e.substr(0,t))}}function vs(e,t,n){const s=e.syncPointTree_.get(t);i(s,"Missing sync point for query tag that we're tracking");return Vi(s,n,pi(e.pendingWriteTree_,t),null)}function Cs(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(i(zi,"Reference.ts has not been loaded"),zi)(e._repo,e._path):e}class ws{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ws(t)}node(){return this.node_}}class bs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Dt(this.path_,e);return new bs(this.syncTree_,t)}node(){return cs(this.syncTree_,this.path_)}}const Ts=function(e,t,n){return e&&"object"==typeof e?(i(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Es(e[".sv"],t,n):"object"==typeof e[".sv"]?Is(e[".sv"],t):void i(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Es=function(e,t,n){if("timestamp"===e)return n.timestamp;i(!1,"Unexpected server value: "+e)},Is=function(e,t,n){e.hasOwnProperty("increment")||i(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const s=e.increment;"number"!=typeof s&&i(!1,"Unexpected increment value: "+s);const r=t.node();if(i(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return s;const o=r.getValue();return"number"!=typeof o?s:o+s},ks=function(e,t,n,i){return Ns(t,new bs(n,e),i)},Ss=function(e,t,n){return Ns(e,new ws(t),n)};function Ns(e,t,n){const i=e.getPriority().val(),s=Ts(i,t.getImmediateChild(".priority"),n);let r;if(e.isLeafNode()){const i=e,r=Ts(i.getValue(),t,n);return r!==i.getValue()||s!==i.getPriority().val()?new on(r,mn(s)):e}{const i=e;return r=i,s!==i.getPriority().val()&&(r=r.updatePriority(new on(s))),i.forEachChild(an,((e,i)=>{const s=Ns(i,t.getImmediateChild(e),n);s!==i&&(r=r.updateImmediateChild(e,s))})),r}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const qs=/[\[\].#$\/\u0000-\u001F\u007F]/,Ws=/[\[\].#$\u0000-\u001F\u007F]/,Us=function(e){return"string"==typeof e&&0!==e.length&&!qs.test(e)},Hs=function(e){return"string"==typeof e&&0!==e.length&&!Ws.test(e)},js=function(e){return null===e||"string"==typeof e||"number"==typeof e&&!Ve(e)||e&&"object"==typeof e&&b(e,".sv")},Bs=function(e,t,n,i){i&&void 0===t||zs(P(e,"value"),t,n)},zs=function(e,t,n){const i=n instanceof Et?new qt(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Ut(i));if("function"==typeof t)throw new Error(e+"contains a function "+Ut(i)+" with contents = "+t.toString());if(Ve(t))throw new Error(e+"contains "+t.toString()+" "+Ut(i));if("string"==typeof t&&t.length>10485760/3&&x(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Ut(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,s=!1;if(Je(t,((t,r)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(s=!0,!Us(t)))throw new Error(e+" contains an invalid key ("+t+") "+Ut(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');!function(e,t){e.parts_.length>0&&(e.byteLength_+=1),e.parts_.push(t),e.byteLength_+=x(t),Wt(e)}(i,t),zs(e,r,i),function(e){const t=e.parts_.pop();e.byteLength_-=x(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&s)throw new Error(e+' contains ".value" child '+Ut(i)+" in addition to actual children.")}},$s=function(e,t,n,i){if(i&&void 0===t)return;const s=P(e,"values");if(!t||"object"!=typeof t||Array.isArray(t))throw new Error(s+" must be an object containing the children to replace.");const r=[];Je(t,((e,t)=>{const i=new Et(e);if(zs(s,t,Dt(n,i)),".priority"===Pt(i)&&!js(t))throw new Error(s+"contains an invalid value for '"+i.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(i)})),function(e,t){let n,i;for(n=0;n<t.length;n++){i=t[n];const s=xt(i);for(let t=0;t<s.length;t++)if(".priority"===s[t]&&t===s.length-1);else if(!Us(s[t]))throw new Error(e+"contains an invalid key ("+s[t]+") in path "+i.toString()+'. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"')}t.sort(Ot);let s=null;for(n=0;n<t.length;n++){if(i=t[n],null!==s&&Ft(s,i))throw new Error(e+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}}(s,r)},Vs=function(e,t,n,i){if(!(i&&void 0===n||Hs(n)))throw new Error(P(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ys=function(e,t){if(".info"===kt(t))throw new Error(e+" failed = Can't modify data under /.info/")},Gs=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Us(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Hs(e)}(n))throw new Error(P(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ks{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Qs(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Lt(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Xs(e,t,n){Qs(e,n),Zs(e,(e=>Lt(e,t)))}function Js(e,t,n){Qs(e,n),Zs(e,(e=>Ft(e,t)||Ft(t,e)))}function Zs(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(er(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function er(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qe&&He("event: "+n.toString()),nt(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ir{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){const e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+C(this.snapshot.exportVal())}}class kr{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ur={};let Hr=!1;function jr(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||ze("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),He("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=Tr(r,s),h=l.repoInfo;void 0!==pe&&(a=pe.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${h.namespace}`,l=Tr(r,s),h=l.repoInfo):o=!l.repoInfo.secure;const c=s&&o?new ot(ot.OWNER):new rt(e.name,e.options,t);Gs("Invalid Firebase Database URL",l),At(l.path)||ze("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Ur[t.name];s||(s={},Ur[t.name]=s);let r=s[e.toURLString()];r&&ze("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new tr(e,Hr,n,i),s[e.toURLString()]=r,r}(h,e,c,new st(e.name,n));return new Br(u,e)}class Br{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(nr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Pr(this._repo,It())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Ur[t];n&&n[e.key]===e||ze(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ur(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&ze("Cannot call "+e+" on a deleted database.")}}jt.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},jt.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ne="9.6.9",Z(new F("database",((e,{instanceIdentifier:t})=>jr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ie("@firebase/database","0.12.6",e),ie("@firebase/database","0.12.6","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const zr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(k(e,s.options)&&k(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyDD4yra5chJlaZ-XEggv5_9Fq8o2kwUsNc",authDomain:"bennychatt-1e905.firebaseapp.com",databaseURL:"https://bennychatt-1e905-default-rtdb.europe-west1.firebasedatabase.app",projectId:"bennychatt-1e905",storageBucket:"bennychatt-1e905.appspot.com",messagingSenderId:"757177452204",appId:"1:757177452204:web:bd714c9293f0da70b74109"})),$r=document.getElementById("yourName");$r.addEventListener("click",(e=>{e.preventDefault();const t=document.getElementById("whosYourDaddy"),n=t.value;""==n&&(alert("Skriv ditt namn för f*n"),location.reload()),document.getElementById("legendId").innerHTML=`Ditt användarnamn: ${n}`,$r.style.display="none",t.style.display="none";const i=document.createElement("button");i.setAttribute("class","refreshKnapp"),i.innerHTML="Klicka här för byta namn",document.getElementById("nameButton").appendChild(i),i.addEventListener("click",(e=>{e.preventDefault(),location.reload()}));const s=Rr(zr,"/to-do");let r=[];Wr(s,(e=>{const t=e.val();for(const e of r)e.clearDOM();r=[];for(const e in t)r.push(new o(e,t[e].task,t[e].userName,t[e].theTime));console.log(r),function(){const e=Object.values(t),n=Object.keys(t)[0];console.log(e);for(let t=0;t<e.length;t++);if(e.length>25){Ar(Rr(zr,"/to-do/"+n))}else console.log(e.length)}();const n=document.scrollingElement||document.body;n.scrollTop=n.scrollHeight}));document.querySelector("#add").addEventListener("click",(e=>{e.preventDefault();const t=document.getElementById("chatInput"),n=t.value;""==n&&alert("Skriv något för helvetet");const i=document.getElementById("whosYourDaddy").value,r=new Date,o=(r.getHours(),{userName:i,task:n,theTime:r+""}),a={};a[function(e,t){e=R(e),Ys("push",e._path),Bs("push",t,e._path,!0);const n=ir(e._repo),i=wn(n),s=Dr(e,i),r=Dr(e,i);let o;return o=null!=t?Mr(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}(s).key]=o,Or(s,a),t.value="";const l=document.scrollingElement||document.body;l.scrollTop=l.scrollHeight}));class o{constructor(e,t,n,i){this.id=e,this.task=t,this.userName=n,this.theTime=i,this.displayTask()}displayTask(){const e=document.getElementById("whosYourDaddy").value,t=document.createElement("section"),n=document.getElementById("allChatt");t.setAttribute("class","sectionId"),t.id=this.id,document.body.prepend(t),n.appendChild(t);const i=document.createElement("h4");i.innerText=`Tid: ${this.theTime}\n            Användarnamn: ${this.userName}\n        Meddelande: ${this.task}`;const s=document.createElement("button");s.setAttribute("class","taBortKnapp"),s.innerText="Ta bort inlägget",t.prepend(i,s),s.addEventListener("click",(()=>{Ar(Rr(zr,"/to-do/"+this.id))})),e!=this.userName&&(s.style.display="none")}toggleDone(){}clearDOM(){document.querySelector(`#${this.id}`).remove()}}}));
//# sourceMappingURL=index.c8d08482.js.map
